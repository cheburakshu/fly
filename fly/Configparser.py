...
# PRIVATE METHODS...
    ...
    def __init__(self,fileName):
        ...
        self._cfgparser = configparser.ConfigParser() #SafeConfigParser()
    ...
    def loadConfig(self,fileName):
        ...
        self._cfgparser.read_file(codecs.open(os.path.join(os.getcwd(), self._CONFIG_PATH , fileName), 'r', 'utf-8'))
